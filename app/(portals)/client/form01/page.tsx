...
export default function Form01Page() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // CRITICAL FIX: Lock Form-01 when moving to next step
    await supabase
  ...
  // Rest of the UI rendering (same as before)
  return (
      ...
      <div className="max-w-4xl mx-auto px-4">
        <form onSubmit={handleSubmit} className="bg-white rounded-lg shadow-lg overflow-hidden">
          ...
          <div className="p-6 space-y-8 max-h-[calc(100vh-120px)] overflow-y-auto">
            ...
            {/* SECTION N1.4.1 - Father's Details (simplified for brevity) */}
            <div className="border-b pb-6">
            ...
            {/* SECTION N1.4.2 - Mother's Details (simplified) */}
            <div className="border-b pb-6">
            ...
            {/* SECTION N1.5 - Addresses (simplified) */}
            <div className="border-b pb-6">
            ...
            {/* SECTION N1.8 - Witnesses (simplified) */}
            <div className="border-b pb-6">
