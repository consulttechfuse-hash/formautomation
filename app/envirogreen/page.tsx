...
export default function EnvirogreenPage() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      const sections = ['home', 'vision-mission', 'programmes', 'specialist', 'location', 'team', 'business-model', 'projects', 'get-involved', 'contact'];
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: brandColors.white }}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <Link href="/" className="flex items-center space-x-2">
              <div className="w-8 h-8 rounded-lg flex items-center justify-center" style={{ backgroundColor: '#D54022' }}>
                <span className="text-white font-bold text-sm">TF</span>
              </div>
              <span className="font-bold text-xl text-gray-800">TechFuse</span>
              <span className="text-xs text-gray-500 hidden sm:block">Holdings</span>
            </Link>
            ...
            <div className="hidden md:flex items-center space-x-4">
              ...
              <Link href="/form-automation" className="ml-2 text-white px-3 py-1.5 rounded-md text-sm font-medium transition hover:opacity-90" style={{ backgroundColor: '#D54022' }}>
                Form Automation
              </Link>
            </div>
        ...
        {mobileMenuOpen && (
          <div className="md:hidden bg-white border-t max-h-[80vh] overflow-y-auto">
            <div className="px-4 py-2 space-y-1">
              ...
              <Link href="/form-automation" className="block py-2 text-[#D54022] font-medium" onClick={() => setMobileMenuOpen(false)}>
                Form Automation →
              </Link>
            </div>
          </div>
      ...
      {/* Strategy Section (formerly Vision & Mission) */}
      <section id="vision-mission" className="py-20 px-4" style={{ backgroundColor: brandColors.light }}>
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12"><Compass className="w-12 h-12 mx-auto mb-4" style={{ color: brandColors.primary }} /><h2 className="text-3xl md:text-4xl font-bold mb-4" style={{ color: brandColors.primary }}>Our Strategy</h2></div>
      ...
      <section id="specialist" className="py-20 px-4" style={{ backgroundColor: brandColors.light }}>
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12"><Star className="w-12 h-12 mx-auto mb-4" style={{ color: brandColors.primary }} /><h2 className="text-3xl md:text-4xl font-bold mb-4" style={{ color: brandColors.primary }}>Specialist Services</h2></div>
      ...
      <section id="get-involved" className="py-20 px-4" style={{ backgroundColor: brandColors.light }}>
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12"><Handshake className="w-12 h-12 mx-auto mb-4" style={{ color: brandColors.primary }} /><h2 className="text-3xl md:text-4xl font-bold mb-4" style={{ color: brandColors.primary }}>Get Involved</h2></div>
