        ...
        <div className="max-w-4xl mx-auto px-4 py-8">
          ...
          <div className="bg-white rounded-2xl p-8 shadow-lg text-center">
            ...
            <p className="text-gray-600 text-lg leading-relaxed">
              To provide expert advisory and business development services that transform complex opportunities into 
              bankable outcomes, creating lasting value for investors, communities, and stakeholders across Africa.
            </p>
          </div>
        </div>
      </div>
