      ...
      <footer className="text-white py-12" style={{ backgroundColor: brandColors.section }}>
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid md:grid-cols-4 gap-8">
            <div><div className="flex items-center space-x-2 mb-4"><Image src="/logo.png" alt="Logo" width={48} height={48} /><span className="font-bold text-white">TechFuse Consulting</span></div><p className="text-sm text-gray-300">Professional advisory and business development firm operating under the brand Consult.Consume.</p></div>
