...
export default function FormCheckSubmit() {
  ...
  const handleBackToForm01 = () => {
    router.push('/client/form-01');
  };

  const handleBackToForm17 = () => {
    router.push('/forms/17');
  };
      ...
      <div className="max-w-6xl mx-auto px-4">
        <div className="bg-white rounded shadow p-6 mb-6">
          <div className="flex justify-between items-center">
            <button 
              onClick={handleBackToForm01}
              className="bg-gray-500 text-white px-4 py-2 rounded hover:bg-gray-600"
              title="Back to Form 01"
            >
              ← Form 01
            </button>
            <button 
              onClick={handleBackToForm17}
              className="bg-gray-500 text-white px-4 py-2 rounded hover:bg-gray-600"
            >
              ← Back
            </button>
            <button onClick={() => router.push('/client/dashboard')} className="bg-gray-600 text-white px-4 py-2 rounded">Dashboard</button>
          </div>
